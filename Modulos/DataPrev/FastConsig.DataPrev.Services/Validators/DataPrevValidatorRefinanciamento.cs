...
{
   public class DataPrevValidatorRefinanciamento : AbstractValidator<RefinanciamentoModel>
   {
      public DataPrevValidatorRefinanciamento()
      {
         ...
         RuleFor(c => c.ValorIof).NotNull().WithMessage("O valor do iof não pode ser nulo!");
