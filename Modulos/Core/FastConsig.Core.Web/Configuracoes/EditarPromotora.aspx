<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarPromotora.aspx.cs" Inherits="FastConsig.Core.Web.Configuracoes.EditarPromotora" %>
                           ...
                           <div class="col-md-1">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtCodigo" runat="server"
                                    ...
                                    BindSourceText="Promotoras.Id"
                                    BindSourceValue="Promotoras.Id"></fmk:CustomTextBox>
                              </div>
                           </div>
                           <div class="col-md-2">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtCnpj" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="Promotoras.Cnpj"
                                    BindSourceValue="Promotoras.Cnpj"></fmk:CustomTextBox>
                              </div>
                           </div>
                           ...
                           <div class="col-md-5">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtDescricao" runat="server"
                                    ...
                                    BindSourceValue="Promotoras.Nome"></fmk:CustomTextBox>
                              </div>
                           </div>

                           <div class="col-md-4">
                              <div class="mb-12">
                                 <label class="form-label" for="txtNomeFantasia">Nome Fantasia</label>
                                 <fmk:CustomTextBox ID="txtNomeFantasia" runat="server"
                                    CssClass="form-control"
                                    TabIndex="4"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="Promotoras.NomeFantasia"
                                    BindSourceValue="Promotoras.NomeFantasia"></fmk:CustomTextBox>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="col-md-12">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomDropDownList
                                    ...
                                    Required="true"
                                    BindSourceType="Message"
                                    BindSelectedValue="Promotoras.Gerente"
                           ...
                           <div class="col-md-1">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtCEP" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="Promotoras.Cep"
                                    BindSourceValue="Promotoras.Cep"></fmk:CustomTextBox>
                              </div>
                           </div>
                           <div class="col-md-7">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtEndereco" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="Promotoras.Endereco"
                                    BindSourceValue="Promotoras.Endereco"></fmk:CustomTextBox>
                              </div>
                           </div>
                           ...
                           <div class="col-md-1">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtNumero" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="Promotoras.Numero"
                                    BindSourceValue="Promotoras.Numero"></fmk:CustomTextBox>
                              </div>
                           </div>
                           ...
                           <div class="col-md-3">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtComplemento" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="Promotoras.Complemento"
                                    BindSourceValue="Promotoras.Complemento"></fmk:CustomTextBox>
                              </div>
                           </div>
                           ...
                           <div class="col-md-5">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtBairro" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="Promotoras.Bairro"
                                    BindSourceValue="Promotoras.Bairro"></fmk:CustomTextBox>
                              </div>
                           ...
                           <div class="col-md-5">
                              ...
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtCidade" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="Promotoras.Cidade"
                                    BindSourceValue="Promotoras.Cidade"></fmk:CustomTextBox>
                              </div>
                           </div>
                           <div class="col-md-2">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtEstado" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="Promotoras.Estado"
                                    BindSourceValue="Promotoras.Estado"></fmk:CustomTextBox>
                              </div>
                        ...
                        <div class="row">
                           <div class="col-md-2">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtTelefone" runat="server"
                                    CssClass="form-control"
                                    TabIndex="14"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="Promotoras.Telefone"
                                    BindSourceValue="Promotoras.Telefone"></fmk:CustomTextBox>
                              </div>
                           </div>
                           <div class="col-md-8">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtEmail" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="Promotoras.Email"
                                    BindSourceValue="Promotoras.Email"></fmk:CustomTextBox>
                              </div>
                           </div>
                              ...
                              <div class="mb-12">
                                 <div class="form-check">
                                    <fmk:CustomCheckBox
                                       ...
                                       BindSourceText="Promotoras.Ativo"
                                       BindSourceValue="Promotoras.Ativo"
                                       TabIndex="16"
                                       BindSourceType="Message"
                                       Text="" />
                           ...
                           <div class="col-md-1">
                              <div class="mb-12">
                                 <div class="form-check">
                                    <fmk:CustomCheckBox
                                       ID="chkCorrespondente"
                                       runat="server"
                                       CssClass="form-check-input"
                                       BindSourceText="Promotoras.Correspondente"
                                       BindSourceValue="Promotoras.Correspondente"
                                       TabIndex="17"
                                       BindSourceType="Message"
                                       Text="" />
                                    <label class="form-check-label" for="chkCorrespondente">Correspondente?</label>
                                 </div>
                              </div>
                           </div>
                        </div>
