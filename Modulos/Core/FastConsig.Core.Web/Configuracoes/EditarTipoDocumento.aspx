<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarTipoDocumento.aspx.cs" Inherits="FastConsig.Core.Web.Configuracoes.EditarTipoDocumento" %>
                     ...
                     <div class="mt-4">
                           ...
                           <div class="col-md-3">
                              <div class="mb-1">
                                 ...
                                 <fmk:CustomTextBox ID="txtCodigo" runat="server"
                                    ...
                                    BindSourceText="TipoDocumento.Id"
                                    BindSourceValue="TipoDocumento.Id"></fmk:CustomTextBox>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="mb-3">
                           ...
                           <fmk:CustomTextBox ID="txtDescricao" runat="server"
                              ...
                              BindSourceValue="TipoDocumento.Descricao"></fmk:CustomTextBox>
                        </div>
                        ...
                        <div class="mb-3">
                           <div class="form-check">
                              <fmk:CustomCheckBox 
                                 ...
                                 BindSourceText="TipoDocumento.Selecionavel" 
                                 BindSourceValue="TipoDocumento.Selecionavel"
                                 TabIndex="3" 
                                 BindSourceType="Message" 
                                 Text="" />
                              <label class="form-check-label" for="chkSelecionavel">Selecionavel</label>
                           </div>
                        </div>
                     </div>
                  </div>
