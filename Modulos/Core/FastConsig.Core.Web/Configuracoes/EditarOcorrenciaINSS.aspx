<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarOcorrenciaINSS.aspx.cs" Inherits="FastConsig.Core.Web.Configuracoes.EditarOcorrenciaINSS" %>
                     ...
                     <div class="mt-4">
                           ...
                           <div class="col-md-3">
                              <div class="mb-1">
                                 ...
                                 <fmk:CustomTextBox ID="txtCodigo" runat="server"
                                    ...
                                    BindSourceText="OcorrenciasINSS.Codigo"
                                    BindSourceValue="OcorrenciasINSS.Codigo"></fmk:CustomTextBox>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="mb-3">
                           ...
                           <fmk:CustomTextBox ID="txtDescricao" runat="server"
                              ...
                              autocomplete="off"
                              BindSourceType="Message"
                              BindSourceText="OcorrenciasINSS.Descricao"
                              BindSourceValue="OcorrenciasINSS.Descricao"></fmk:CustomTextBox>
                        </div>
                        ...
                        <div class="mb-3">
                           ...
                           <fmk:CustomDropDownList
                              ...
                              Required="False"
                              BindSourceType="Message"
                              BindSelectedValue="OcorrenciasINSS.Acao"
                        ...
                        <div class="mb-3">
                           ...
                           <fmk:CustomDropDownList
                              ...
                              Required="False"
                              BindSourceType="Message"
                              BindSelectedValue="OcorrenciasINSS.Ocorrencia"
