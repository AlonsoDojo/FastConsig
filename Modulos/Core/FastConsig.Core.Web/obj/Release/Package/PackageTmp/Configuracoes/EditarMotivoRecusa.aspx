<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarMotivoRecusa.aspx.cs" Inherits="FastConsig.Core.Web.Configuracoes.EditarMotivoRecusa" %>
                     ...
                     <div class="mt-4">
                           ...
                           <div class="col-md-3">
                              <div class="mb-1">
                                 ...
                                 <fmk:CustomTextBox ID="txtCodigo" runat="server"
                                    ...
                                    BindSourceText="MotivoRecusa.Id"
                                    BindSourceValue="MotivoRecusa.Id"></fmk:CustomTextBox>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="mb-3">
                           ...
                           <fmk:CustomTextBox ID="txtDescricao" runat="server"
                              ...
                              autocomplete="off"
                              BindSourceType="Message"
                              BindSourceText="MotivoRecusa.Descricao"
                              BindSourceValue="MotivoRecusa.Descricao"></fmk:CustomTextBox>
                        </div>
                     </div>
                  </div>
               </div>
