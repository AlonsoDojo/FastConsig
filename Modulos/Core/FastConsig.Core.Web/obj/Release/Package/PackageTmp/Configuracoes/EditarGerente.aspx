<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarGerente.aspx.cs" Inherits="FastConsig.Core.Web.Configuracoes.EditarGerente" %>
                     ...
                     <div class="mt-4">
                           ...
                           <div class="col-md-3">
                              <div class="mb-1">
                                 ...
                                 <fmk:CustomTextBox ID="txtCodigo" runat="server"
                                    ...
                                    BindSourceText="Gerentes.Id"
                                    BindSourceValue="Gerentes.Id"></fmk:CustomTextBox>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="mb-3">
                           ...
                           <fmk:CustomTextBox ID="txtNome" runat="server"
                              ...
                              BindSourceValue="Gerentes.Nome"></fmk:CustomTextBox>
                        </div>
                           ...
                           <div class="col-md-3">
                              <div class="mb-1">
                                 ...
                                 <fmk:CustomTextBox ID="txtCPF" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="Gerentes.Cpf"
                                    BindSourceValue="Gerentes.Cpf"></fmk:CustomTextBox>
                              </div>
                           </div>
                        </div>
