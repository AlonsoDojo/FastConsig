<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarMotivoBloqueio.aspx.cs" Inherits="FastConsig.Core.Web.Configuracoes.EditarMotivoBloqueio" %>
                     ...
                     <div class="mt-4">
                           ...
                           <div class="col-md-3">
                              <div class="mb-1">
                                 ...
                                 <fmk:CustomTextBox ID="txtCodigo" runat="server"
                                    ...
                                    BindSourceText="MotivoBloqueio.Id"
                                    BindSourceValue="MotivoBloqueio.Id"></fmk:CustomTextBox>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="mb-3">
                           ...
                           <fmk:CustomTextBox ID="txtDescricao" runat="server"
                              ...
                              autocomplete="off"
                              BindSourceType="Message"
                              BindSourceText="MotivoBloqueio.Descricao"
                              BindSourceValue="MotivoBloqueio.Descricao"></fmk:CustomTextBox>
                        </div>
                     </div>
                  </div>
               </div>
