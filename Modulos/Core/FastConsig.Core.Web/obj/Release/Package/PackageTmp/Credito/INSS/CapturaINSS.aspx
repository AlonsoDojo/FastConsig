<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="CapturaINSS.aspx.cs" Inherits="FastConsig.Core.Web.Credito.INSS.CapturaINSS" EnableViewState="true" %>
                                                            ...
                                                            <div class="card">
                                                               <div class="card-body">
                                                                  ...
                                                                  <div class="row">
                                                                     ...
                                                                     <div class="col-md-2">
                                                                        <div class="mb-12">
                                                                           <label class="form-label" for="ddlIndicadorAnalfabetismo">Ind.Anafalbetismo</label>
                                                                           <fmk:CustomDropDownList
                                                                              ID="ddlIndicadorAnalfabetismo"
                                                                              runat="server"
                                                                              CssClass="form-control dropdown-toggle select2-selection form-select"
                                                                              TabIndex="39"
                                                                              BindSelectedType="Message"
                                                                              ...
                                                                              Enabled="true"
                                                                              BindSourceType="Message"
                                                                              BindSelectedValue="PropostaModel.Proponente.IndicadorAnalfabetismo"
                                                                  ...
                                                                  <div class="row">
                                                                     <div class="col-md-6">
                                                                        <div class="mb-12">
                                                                           <label class="form-label" for="ddlEspecieBeneficio">Espécie de Benefício</label>
                                                                           <fmk:CustomDropDownList
                                                                              ID="ddlEspecieBeneficio"
                                                                              runat="server"
                                                                              CssClass="form-control dropdown-toggle select2-selection form-select"
                                                                              TabIndex="40"
                                                                              BindSelectedType="Message"
                                                                              ...
                                                                              Enabled="false"
                                                                              BindSourceType="Message"
                                                                              BindSelectedValue="PropostaModel.Proponente.EspecieBeneficio"
                                                                              DefaultSelectedItem="(Selecione a Espécie de Benefício)"
                                                                              BindSourceText="EspecieBeneficio.Descricao"
                                                                              BindSourceValue="EspecieBeneficio.Id">
                                                                           </fmk:CustomDropDownList>
                                                                        </div>
                                                                     </div>
                                                                     ...
                                                                     <div class="col-md-1">
                                                                        <div class="mb-12">
                                                                           <label class="form-label" for="txtBancoBeneficio">Banco</label>
                                                                           <fmk:CustomTextBox ID="txtBancoBeneficio" runat="server"
                                                                              CssClass="form-control"
                                                                              TabIndex="42"
                                                                              placeholder="Banco"
                                                                              BindSelectedType="Message"
                                                                              ...
                                                                              autocomplete="off"
                                                                              BindSourceType="Message"
                                                                              BindSourceText="PropostaModel.Proponente.IfPagadora"
                                                                              BindSourceValue="PropostaModel.Proponente.IfPagadora">
                                                                           </fmk:CustomTextBox>
                                                                        </div>
                                                                     </div>
                                                                     ...
                                                                     <div class="col-md-1">
                                                                        <div class="mb-12">
                                                                           <label class="form-label" for="txtAgenciaBeneficio">Agência</label>
                                                                           <fmk:CustomTextBox ID="txtAgenciaBeneficio" runat="server"
                                                                              CssClass="form-control"
                                                                              TabIndex="43"
                                                                              placeholder="Agência"
                                                                              BindSelectedType="Message"
                                                                              ...
                                                                              autocomplete="off"
                                                                              BindSourceType="Message"
                                                                              BindSourceText="PropostaModel.Proponente.AgenciaPagadora"
                                                                              BindSourceValue="PropostaModel.Proponente.AgenciaPagadora">
                                                                           </fmk:CustomTextBox>
                                                                        </div>
                                                                     </div>
                                                                     ...
                                                                     <div class="col-md-2">
                                                                        <div class="mb-12">
                                                                           <label class="form-label" for="txtContaBeneficio">Conta</label>
                                                                           <fmk:CustomTextBox ID="txtContaBeneficio" runat="server"
                                                                              CssClass="form-control"
                                                                              TabIndex="44"
                                                                              placeholder="Conta"
                                                                              BindSelectedType="Message"
                                                                              ...
                                                                              autocomplete="off"
                                                                              BindSourceType="Message"
                                                                              BindSourceText="PropostaModel.Proponente.ContaCorrente"
                                                                              BindSourceValue="PropostaModel.Proponente.ContaCorrente">
                                                                           </fmk:CustomTextBox>
                                                                        </div>
                                                                     </div>
                                                                  </div>
