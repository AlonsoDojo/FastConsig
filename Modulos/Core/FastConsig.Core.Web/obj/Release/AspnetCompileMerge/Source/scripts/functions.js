(function ($) {
    ...
    $(".sidebar-collapse-icon").click(function (event) {
        ...
        if (localStorage) {
            localStorage.setItem("__CRDMG_SideBar_Collapssed__", $container.hasClass('can-resize'));
        }
    ...
    if (localStorage) {
        $is_collapsed = localStorage.getItem("__SideBar_Collapssed__");
    ...
    $('body').off().on('click', '.panel > .panel-heading > .panel-tool-options li > a[data-rel="reload"]', function (ev)
    {
        ev.preventDefault();
    ...
    }).off().on('click', '.panel > .panel-heading > .panel-tool-options li > a[data-rel="close"]', function (ev)
    {
        ev.preventDefault();
    ...
    }).off().on('click', '.panel > .panel-heading > .panel-tool-options li > a[data-rel="collapse"]', function (ev)
    {
        ev.preventDefault();
