<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarFamiliaProduto.aspx.cs" Inherits="FastConsig.Core.Web.Configuracoes.EditarFamiliaProduto" %>
                     ...
                     <div class="mt-4">
                           ...
                           <div class="col-md-3">
                              <div class="mb-1">
                                 ...
                                 <fmk:CustomTextBox ID="txtCodigo" runat="server"
                                    ...
                                    BindSourceText="FamiliaProduto.Id"
                                    BindSourceValue="FamiliaProduto.Id"></fmk:CustomTextBox>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="mb-3">
                           ...
                           <fmk:CustomTextBox ID="txtDescricao" runat="server"
                              ...
                              autocomplete="off"
                              BindSourceType="Message"
                              BindSourceText="FamiliaProduto.Descricao"
                              BindSourceValue="FamiliaProduto.Descricao"></fmk:CustomTextBox>
                        </div>
                     </div>
                  </div>
               </div>
