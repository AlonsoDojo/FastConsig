<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dominios.aspx.cs" Inherits="FastConsig.Core.Web.Seguranca.Dominios" %>
         ...
         <div class="card">
            <div class="card-body">
               <div class="table-responsive">
                  ...
                  <asp:Repeater ID="DominiosRepeater" runat="server" OnItemDataBound="DominiosRepeater_ItemDataBound">
                     <HeaderTemplate>
                     ...
                     <ItemTemplate>
                        <tr>
                           ...
                           <td>
                              <fmk:CustomLabel ID="lblTipo" runat="server" /></td>
