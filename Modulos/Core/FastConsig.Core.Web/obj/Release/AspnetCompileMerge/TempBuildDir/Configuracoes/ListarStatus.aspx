<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListarStatus.aspx.cs" Inherits="FastConsig.Core.Web.Configuracoes.ListarStatus" %>
            ...
            <div class="card-body">
               <div class="table-responsive">
                  ...
                  <asp:Repeater ID="StatusRepeater" runat="server" OnItemDataBound="StatusRepeater_ItemDataBound">
                     <HeaderTemplate>
                        <table class="table table-centered table-nowrap mb-0 no-footer dtr-inline nowrap table-card-list dt-responsive DataTables" style="width: 99%;" id="tabelaStatus">
