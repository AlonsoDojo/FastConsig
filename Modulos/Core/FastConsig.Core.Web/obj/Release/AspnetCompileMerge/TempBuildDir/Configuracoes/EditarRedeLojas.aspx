<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarRedeLojas.aspx.cs" Inherits="FastConsig.Core.Web.Configuracoes.EditarRedeLojas" %>
                           ...
                           <div class="col-md-1">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtCodigo" runat="server"
                                    ...
                                    BindSourceText="RedeLoja.Id"
                                    BindSourceValue="RedeLoja.Id"></fmk:CustomTextBox>
                              </div>
                           </div>
                           <div class="col-md-2">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtCnpj" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="RedeLoja.Cnpj"
                                    BindSourceValue="RedeLoja.Cnpj"></fmk:CustomTextBox>
                              </div>
                           </div>
                           ...
                           <div class="col-md-9">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtDescricao" runat="server"
                                    ...
                                    BindSourceValue="RedeLoja.Nome"></fmk:CustomTextBox>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="col-md-12">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomDropDownList
                                    ...
                                    Required="true"
                                    BindSourceType="Message"
                                    BindSelectedValue="RedeLoja.Promotora"
                           ...
                           <div class="col-md-1">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtCEP" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="RedeLoja.Cep"
                                    BindSourceValue="RedeLoja.Cep"></fmk:CustomTextBox>
                              </div>
                           </div>
                           <div class="col-md-7">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtEndereco" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="RedeLoja.Endereco"
                                    BindSourceValue="RedeLoja.Endereco"></fmk:CustomTextBox>
                              </div>
                           </div>
                           ...
                           <div class="col-md-1">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtNumero" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="RedeLoja.Numero"
                                    BindSourceValue="RedeLoja.Numero"></fmk:CustomTextBox>
                              </div>
                           </div>
                           ...
                           <div class="col-md-3">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtComplemento" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="RedeLoja.Complemento"
                                    BindSourceValue="RedeLoja.Complemento"></fmk:CustomTextBox>
                              </div>
                           </div>
                           ...
                           <div class="col-md-5">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtBairro" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="RedeLoja.Bairro"
                                    BindSourceValue="RedeLoja.Bairro"></fmk:CustomTextBox>
                              </div>
                           ...
                           <div class="col-md-5">
                              ...
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtCidade" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="RedeLoja.Cidade"
                                    BindSourceValue="RedeLoja.Cidade"></fmk:CustomTextBox>
                              </div>
                           </div>
                           <div class="col-md-2">
                              <div class="mb-12">
                                 ...
                                 <fmk:CustomTextBox ID="txtEstado" runat="server"
                                    ...
                                    autocomplete="off"
                                    BindSourceType="Message"
                                    BindSourceText="RedeLoja.Estado"
                                    BindSourceValue="RedeLoja.Estado"></fmk:CustomTextBox>
                              </div>
