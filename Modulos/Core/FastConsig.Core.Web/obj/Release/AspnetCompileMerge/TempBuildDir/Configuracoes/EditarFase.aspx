<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarFase.aspx.cs" Inherits="FastConsig.Core.Web.Configuracoes.EditarFase" %>
                     ...
                     <div class="mt-4">
                           ...
                           <div class="col-md-3">
                              <div class="mb-1">
                                 ...
                                 <fmk:CustomTextBox ID="txtCodigo" runat="server"
                                    ...
                                    BindSourceText="Fases.Id"
                                    BindSourceValue="Fases.Id"></fmk:CustomTextBox>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="mb-3">
                           ...
                           <fmk:CustomTextBox ID="txtDescricao" runat="server"
                              ...
                              BindSourceValue="Fases.Descricao"></fmk:CustomTextBox>
                        </div>
                     </div>
                  </div>
               </div>
