<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarTipoBeneficioINSS.aspx.cs" Inherits="FastConsig.Core.Web.Configuracoes.EditarTipoBeneficioINSS" %>
                     ...
                     <div class="mt-4">
                           ...
                           <div class="col-md-3">
                              <div class="mb-1">
                                 ...
                                 <fmk:CustomTextBox ID="txtCodigo" runat="server"
                                    ...
                                    BindSourceText="TipoBeneficioINSS.Id"
                                    BindSourceValue="TipoBeneficioINSS.Id"></fmk:CustomTextBox>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="mb-3">
                           ...
                           <fmk:CustomTextBox ID="txtDescricao" runat="server"
                              ...
                              autocomplete="off"
                              BindSourceType="Message"
                              BindSourceText="TipoBeneficioINSS.Descricao"
                              BindSourceValue="TipoBeneficioINSS.Descricao"></fmk:CustomTextBox>
                        </div>

                        <div class="mb-3">
                           <label class="form-label" for="txtUtilizacao">Utilização</label>
                           <fmk:CustomTextBox ID="txtUtilizacao" runat="server"
                              CssClass="form-control"
                              TabIndex="2"
                              placeholder="Descrição"
                              BindSelectedType="Message"
                              ...
                              autocomplete="off"
                              BindSourceType="Message"
                              BindSourceText="TipoBeneficioINSS.Utilizacao"
                              BindSourceValue="TipoBeneficioINSS.Utilizacao"></fmk:CustomTextBox>
                        </div>
                        ...
                        <div class="mb-3">
                           <div class="form-check">
                              <fmk:CustomCheckBox 
                                 ...
                                 BindSourceText="TipoBeneficioINSS.Aceito" 
                                 BindSourceValue="TipoBeneficioINSS.Aceito"
                                 TabIndex="3" 
                                 BindSourceType="Message" 
                                 Text="" />
                              <label class="form-check-label" for="chkSelecionavel">Aceito?</label>
                           </div>
                        </div>
                     </div>
                  </div>
