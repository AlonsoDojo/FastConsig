<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarOcorrencia.aspx.cs" Inherits="FastConsig.Core.Web.Configuracoes.EditarOcorrencia" %>
                     ...
                     <div class="mt-4">
                           ...
                           <div class="col-md-3">
                              <div class="mb-1">
                                 ...
                                 <fmk:CustomTextBox ID="txtCodigo" runat="server"
                                    ...
                                    BindSourceText="Ocorrencias.Id"
                                    BindSourceValue="Ocorrencias.Id"></fmk:CustomTextBox>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="mb-3">
                           ...
                           <fmk:CustomTextBox ID="txtDescricao" runat="server"
                              ...
                              BindSourceValue="Ocorrencias.Descricao"></fmk:CustomTextBox>
                        </div>
                        ...
                        <div class="mb-3">
                           <div class="form-check">
                              <fmk:CustomCheckBox 
                                 ...
                                 BindSourceText="Ocorrencias.Pendencia" 
                                 BindSourceValue="Ocorrencias.Pendencia"
                                 TabIndex="3" 
                                 BindSourceType="Message" 
                                 Text="" />
                              <label class="form-check-label" for="chkSelecionavel">Pendência</label>
                           </div>
                        </div>
                        ...
                        <div class="mb-3">
                           <div class="form-check">
                              <fmk:CustomCheckBox 
                                 ...
                                 runat="server" 
                                 CssClass="form-check-input"
                                 BindSourceText="Ocorrencias.Recusa" 
                                 BindSourceValue="Ocorrencias.Recusa"
                                 TabIndex="4" 
                                 BindSourceType="Message" 
                                 Text="" />
                              <label class="form-check-label" for="chkRecusa">Recusa</label>
                           </div>
                        </div>
                        ...
                        <div class="mb-3">
                           <div class="form-check">
                              <fmk:CustomCheckBox 
                                 ...
                                 runat="server" 
                                 CssClass="form-check-input"
                                 BindSourceText="Ocorrencias.Informativa" 
                                 BindSourceValue="Ocorrencias.Informativa"
                                 TabIndex="5" 
                                 BindSourceType="Message" 
                                 Text="" />
                              <label class="form-check-label" for="chkInformativa">Informativa</label>
                           </div>
                        </div>
                     </div>
                  </div>
