...
{
   public partial class EditarUsuarioAdmin : FastConsigPageBase
   {
      protected void Page_Load(object sender, EventArgs e)
      {
         VerificarPermissaoAcesso("UsuariosAdmin.aspx");
      ...
      protected void btnSalvar_Click(object sender, EventArgs e)
      {
         ...
         //UsuarioService.GetInstance().SalvarUsuario(usuario);
      ...
      protected void btnExcluir_Click(object sender, EventArgs e)
      {
         ...
         Response.Redirect("/Seguranca/UsuariosAdmin.aspx", false);
      }
      ...
      private void CarregarPerfis()
      {
         //*------- Preenche o grig de perfis...
         var usuarioSrv = UsuarioService.GetInstance();
         var perfis = UsuarioService.GetInstance().ListarPerfis();
