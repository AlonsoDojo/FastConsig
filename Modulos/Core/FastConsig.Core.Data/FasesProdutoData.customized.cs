...
{
	public partial class FasesProdutoData
	{
		
		public FasesProdutoData() {
		...
		void Handle_CustomizeQuery(QueryBuilder query) {
			...
			//------------------------------------------------------------------
			//query.Join(FasesProduto.METADADO.Produto, Join.Inner, Produtos.METADADO.Id)
			...
			//------------------------------------------------------------------
			//query.Join(FasesProduto.METADADO.Fase, Join.Inner, Fases.METADADO.Id)
