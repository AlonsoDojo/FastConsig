...
{
   public partial class PoliticaConfiguracaoExecucaoSimulacaoData
   {

      public PoliticaConfiguracaoExecucaoSimulacaoData()
      {
      ...
      void Handle_CustomizeQuery(QueryBuilder query)
      {
         ...
         //------------------------------------------------------------------
         //query.Join(PoliticaConfiguracaoExecucaoSimulacao.METADADO.Produto, Join.Inner, Produtos.METADADO.Id)
         ...
         //------------------------------------------------------------------
         //query.Join(PoliticaConfiguracaoExecucaoSimulacao.METADADO.TipoPessoa, Join.Inner, TipoPessoa.METADADO.Id)
         //     .Field(TipoPessoa.METADADO.Codigo, "CodigoTipoPessoa")
         //     .Field(TipoPessoa.METADADO.Descricao, "DescricaoTipoPessoa");
         //------------------------------------------------------------------

         query.Join(PoliticaConfiguracaoExecucaoSimulacao.METADADO.Politica, Join.Left, Politicas.METADADO.Id)
              .Field(Politicas.METADADO.Metodo, "Metodo")
              .Field(Politicas.METADADO.Simulacao, "Simulacao");
         query.Join(PoliticaConfiguracaoExecucaoSimulacao.METADADO.TipoPessoa, Join.Left, TipoPessoa.METADADO.Id)
