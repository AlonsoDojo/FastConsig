...
{
   public class AverbacaoEmprestimoConsignadoModel : PropostaBaseModel
   {
      ...
      public int ClassificadorModalidade { get; set; }
      ...
      public string CpfCorrespondente { get; set; }
      ...
      public decimal? CanalAtendimento { get; set; }
