...
{
   public class ReverterRefinanciamentoModel : PropostaBaseModel
   {
      ...
      [JsonProperty("motivoReversao", NullValueHandling = NullValueHandling.Ignore)]
      public long? MotivoReversao { get; set; }
   }
}
