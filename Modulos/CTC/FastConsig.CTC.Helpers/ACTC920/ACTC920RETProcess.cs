...
{
   public class ACTC920RETProcess : IACTCProcess
   {
      public void Execute(int? idArquivo)
      {
         ...
         FastConsig.CTC.Model.ACTC920.ACTC920 obj = (FastConsig.CTC.Model.ACTC920.ACTC920)new ACTC920RETParser().Parse(new System.IO.StringReader(arquivo.Conteudo));
