...
{
   public class ACTC923PROProcess : IACTCProcess
   {
      public void Execute(int? idArquivo)
      {
         ...
         FastConsig.CTC.Model.ACTC923.ACTC923PRO obj = (FastConsig.CTC.Model.ACTC923.ACTC923PRO)new ACTC923PROParser().Parse(new System.IO.StringReader(arquivo.Conteudo));
