...
{
   public class ACTC923RETProcess : IACTCProcess
   {
      public void Execute(int? idArquivo)
      {
         ...
         FastConsig.CTC.Model.ACTC923.ACTC923 obj = (FastConsig.CTC.Model.ACTC923.ACTC923)new ACTC923RETParser().Parse(new System.IO.StringReader(arquivo.Conteudo));
