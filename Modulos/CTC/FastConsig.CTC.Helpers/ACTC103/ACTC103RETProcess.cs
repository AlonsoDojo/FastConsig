...
{
   public class ACTC103RETProcess : IACTCProcess
   {
      public void Execute(int? idArquivo)
      {
         ...
         FastConsig.CTC.Model.ACTC103.ACTC103 obj = (FastConsig.CTC.Model.ACTC103.ACTC103)new ACTC103RETParser().Parse(new System.IO.StringReader(arquivo.Conteudo));
