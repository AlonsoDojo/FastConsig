...
{
   public class ACTC900RETProcess : IACTCProcess
   {
      public void Execute(int? idArquivo)
      {
         ...
         FastConsig.CTC.Model.ACTC900.ACTC900 obj = (FastConsig.CTC.Model.ACTC900.ACTC900)new ACTC900RETParser().Parse(new System.IO.StringReader(arquivo.Conteudo));
