...
{
   public class ACTC902ERRProcess : IACTCProcess
   {
      public void Execute(int? idArquivo)
      {
         ...
         FastConsig.CTC.Model.ACTC902.ACTC902ERR obj = (FastConsig.CTC.Model.ACTC902.ACTC902ERR)new ACTC902ERRParser().Parse(new System.IO.StringReader(arquivo.Conteudo));
