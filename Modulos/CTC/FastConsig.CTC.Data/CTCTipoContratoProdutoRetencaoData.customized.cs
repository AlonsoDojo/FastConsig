...
{
	public partial class CTCTipoContratoProdutoRetencaoData
	{
		
		public CTCTipoContratoProdutoRetencaoData() {
		...
		void Handle_CustomizeQuery(QueryBuilder query) {
			...
			//------------------------------------------------------------------
			//query.Join(CTCTipoContratoProdutoRetencao.METADADO.ProdutoRetencao, Join.Inner, Produtos.METADADO.Id)
			...
			//     .Field(Produtos.METADADO.ExibeInstituidor, "ExibeInstituidorProdutos")
			//     .Field(Produtos.METADADO.BloqueiaProposta, "BloqueiaPropostaProdutos")
			//     .Field(Produtos.METADADO.ProfissionalCertificadoObrigatorio, "ProfissionalCertificadoObrigatorioProdutos");
			//------------------------------------------------------------------
