...
{
	public partial class ComunicadosConfirmacaoLeituraData
	{
		
		public ComunicadosConfirmacaoLeituraData() {
		...
		void Handle_CustomizeQuery(QueryBuilder query) {
			...
			//------------------------------------------------------------------
			//query.Join(ComunicadosConfirmacaoLeitura.METADADO.Usuario, Join.Inner, Usuario.METADADO.Id)
